// /**
    ...
    //     pkg.DIFF_DELETE = DIFF_DELETE;
    //     pkg.DIFF_INSERT = DIFF_INSERT;
    //     pkg.DIFF_EQUAL = DIFF_EQUAL;
    //     /**
    ...
    //     // pkg.cleanupSemantic = diff_cleanupSemantic;
    ...
    //     /** https://github.com/facebook/jest/blob/cd98198c9397d8b69c55155d7b224d62ef117a90/packages/jest-diff/src/diffStrings.ts#L12 */
    //     function diffStrings(a, b) {
    //         function isCommon(aIdx, bIdx) {
    ...
    //     // pkg.diffStrings = diffStrings;


    //     var pkg_printDiffs = package(function(register) {
    //         var printAnnotation = register(function printAnnotation(options, changeCounts) {
    //             var aAnnotation = options.aAnnotation;
    //             var aColor = options.aColor;
    //             var aIndicator = options.aIndicator;
    //             var bAnnotation = options.bAnnotation;
    //             var bColor = options.bColor;
    //             var bIndicator = options.bIndicator;
    //             var includeChangeCounts = options.includeChangeCounts;
    //             var omitAnnotationLines = options.omitAnnotationLines;
    ...
    //         var printDiffLines = register(function printDiffLines(diffs, options) {
    ...
    //     var pkg_diffLines = package(function(register) {
    //         var diffLinesRaw = register(function diffLinesRaw(aLines, bLines) {
    //             var aLength = aLines.length;
    //             var bLength = bLines.length;

    //             var isCommon = function(aIdx, bIdx) {
    //                 return aLines[aIdx] === bLines[bIdx];
    //             }
    ...
    //         /** https://github.com/facebook/jest/blob/cd98198c9397d8b69c55155d7b224d62ef117a90/packages/jest-diff/src/diffLines.ts#L18 */
    //         var diffLinesUnified = register(function diffLinesUnified(aLines, bLines, options) {
    ...
    //     /** https://github.com/facebook/jest/blob/cd98198c9397d8b69c55155d7b224d62ef117a90/packages/jest-diff/src/printDiffs.ts#L219 */
    //     function diffStringsUnified(a, b, options) {
    //         // if (a !== b && a.length !== 0 && b.length !== 0) {
    //         //     var isMultiline = a.includes('\n') || b.includes('\n');

    //         //     // getAlignedDiffs assumes that a newline was appended to the strings.
    //         //     var diffs = diffStringsRaw(
    //         //         isMultiline ? a + '\n' : a,
    //         //         isMultiline ? b + '\n' : b,
    ...
    //     pkg.diffStringsUnified = diffStringsUnified;

    //     /** https://github.com/facebook/jest/blob/cd98198c9397d8b69c55155d7b224d62ef117a90/packages/jest-diff/src/printDiffs.ts#L247 */
    //     function diffStringsRaw(a, b, cleanup) {
    //         var diffs = diffStrings(a, b);

    //         if (cleanup) {
    //             diff_cleanupSemantic(diffs); // impure function
    //         }

    //         return diffs;
    //     }

    //     pkg.diffStringsRaw = diffStringsRaw;
    // })({});